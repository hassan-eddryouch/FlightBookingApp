...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        flightList.add(
            Flight("Air Maroc", "CAS", "06:30", "CDG", "10:45", "04h 15m", "€320", "Free Meal"))
        flightList.add(
            Flight("Iberia", "MAD", "09:00", "BCN", "10:30", "01h 30m", "€120", "Snack included"))
        flightList.add(
            Flight("TAP Portugal", "LIS", "07:45", "OPO", "08:45", "01h 00m", "€90", "Meal included")
        )
        flightList.add(
            Flight("Air Maroc", "CAS", "08:00", "PAR", "12:00", "04h 00m", "€310", "Free Meal")
        )
